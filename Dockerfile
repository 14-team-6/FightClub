...
RUN npm i express compression cookie-parser react react-dom redux @redux-devtools/extension react-redux redux-thunk react-router-dom styled-components react-hook-form yup @hookform/resolvers classnames
