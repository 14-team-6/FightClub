...
import dieLeft from '@frontend/public/img/die-left-frame.png';
import dieRight from '@frontend/public/img/die-right-frame.png';
import { CharacterState } from '@frontend/src/game/types';

export default () => ({
  [CharacterState.DIE]: {
    img: imageFromSrc(dieLeft, dieRight),
    frameIndex: 0,
    tickCount: 0,
    ticksPerFrame: 5,
    numberOfFrames: 6,
